    ...
    public static class HexEncoding
    {
        ...
        public static byte[] GetBytes(string hexString)
        {
            ...
            try
            {
                ...
                {
                    int charIndex = i * 2;
                    string tmpSubstring = verifiedHexString.Substring(charIndex, 2);
        ...
        {
            c = Char.ToUpper(c);
            //look-up the char in _hexChars Array
            bool isHexChar = (Array.BinarySearch(_hexChars, c) >= 0);
            return isHexChar;
        }
